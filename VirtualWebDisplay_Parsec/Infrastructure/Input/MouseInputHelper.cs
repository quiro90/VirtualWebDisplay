...
/// <summary>
/// Inyecta eventos de mouse sint�ticos en Windows usando SendInput API.
/// Compatible con Parsec VDD (pantallas virtuales).
/// NO requiere permisos de Admin.
/// </summary>
internal static class MouseInputHelper
{
    // �ltima posici�n conocida del cursor para restaurar tras gestos/tap
    private static POINT? _lastCursorPosition = null;

    /// <summary>
    /// Guarda la posici�n actual del cursor para restaurar luego.
    /// </summary>
    ...
    /// <summary>
    /// Restaura la �ltima posici�n guardada del cursor, si existe.
    /// </summary>
    ...
    /// <summary>
    /// Click izquierdo en coordenadas objetivo y luego restaura la posici�n original del cursor.
    /// </summary>
    ...
    /// <summary>
    /// Posiciona el cursor y env�a LEFTDOWN (inicio de arrastre).
    /// </summary>
    ...
    /// <summary>
    /// Doble-click izquierdo (dos clicks consecutivos con peque�a pausa).
    /// </summary>
    ...
    /// <summary>
    /// Click derecho en coordenadas objetivo y luego restaura la posici�n original del cursor.
    /// </summary>
    ...
    /// <summary>
    /// Click central en coordenadas objetivo y luego restaura la posici�n original del cursor.
    /// </summary>
    ...
    /// <summary>
    /// Env�a eventos de scroll vertical y/u horizontal (ambos opcionales, pueden ser 0).
    /// </summary>
